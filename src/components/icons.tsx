...
export function FlagPe4x3(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1.34em"
      ...
      {...props}
    >
      <path fill="#D91023" d="M0 0h640v480H0z"></path>
      <path fill="#fff" d="M213.3 0h213.4v480H213.3z"></path>
    </svg>
  );
}

export function MdiSeatPassenger(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function PhSteeringWheel(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
